        ...
        <form id="updateProfileForm" method="POST" action="{{ route('update_profil', $user->user_id) }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <div class="mb-2">
                        @if($user->photo)
                        <img id="photo-preview" src="{{ asset('storage/profiles/' . $user->photo) }}"
                            alt="Foto Profil" class="img-fluid rounded-circle border border-primary shadow-sm"
                            style="width: 100px; height: 100px; object-fit: cover;">
                        @else
                        <img id="photo-preview" src="{{ asset('adminlte/dist/img/AdminLTELogo.png') }}"
                            alt="Foto Profil Default" class="img-fluid rounded-circle border border-primary shadow-sm"
                            style="width: 100px; height: 100px; object-fit: cover;">
                        @endif
                    </div>
