...
<head>
    ...
    <title>404 Forbidden - {{ config('app.name', 'Aplikasi Anda') }}</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="error-container">
        <p>> <span>ERROR CODE</span>: "<i>HTTP 404 Forbidden</i>"</p>
        <p>> <span>ERROR DESCRIPTION</span>: "<i>Halaman yang anda cari tidak ditemukan.</i>"</p>
        <p>> <span>POSSIBLE CAUSES</span>: [<b>Cari yang lain aja..</b>]</p>
    </div>
