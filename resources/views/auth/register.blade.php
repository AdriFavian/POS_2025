        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('register.post') }}" method="POST" id="form-register">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" style="border-radius: 120px; margin-top: 10%; background-color: rgb(41, 184, 41); border-color: white;">Daftar</button>
                </form>
                <p class="mb-0 mt-3">
