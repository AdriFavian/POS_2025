        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card border-0 shadow-sm bg-light mb-3">
                    <div class="card-body p-3">
                        ...
                        <div class="border rounded p-2 d-flex flex-wrap justify-content text-dark small mb-3"
                            ...
                            <div class="px-2"><strong>Kolom A:</strong> level_kode</div>
                            <div class="px-2"><strong>Kolom B:</strong> level_nama</div>
                        </div>
                ...
                <div class="form-group">
                    <label for="file_level" class="font-weight-bold">
                        File Excel (.xlsx)
                    </label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="file_level" name="file_level" required>
                        <label class="custom-file-label" for="file_level">
                            Pilih file...
                        </label>
                    </div>
